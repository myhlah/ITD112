...
// radar
  ...
  const options = {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: 'Correlation of Study Habits with Various Performance Metrics',
      },
    },
    scales: {
      r: {
    ...
    <div className="container">
     ...
     <div className="form-container1">
       ...
       <div className="charts-container">
          ...
          <div className="chart-column">
            <h2>Average NAT Results by Type of School and Socio-economic Status</h2>
            <Bar data={data} options={option2} />
          </div>
          <div className="chart-column">
            <h2>Study Habits vs Academic Performance and NAT Results</h2>
            <Radar data={radarData} options={options} />
            
          </div>
          <div className="chart-column">
            <h2>Distribution of Academic Performance Categories</h2>
            <Doughnut data={radialBarData} options={options3} style={{ width: '250px', height: '250px', marginLeft:'50px' }}/>
          </div>
        </div>
    </div>
  );  
